...
import {
  View, ScrollView, Text, ActivityIndicator, FlatList, Alert, Keyboard, RefreshControl,
  Dimensions, Modal, TouchableOpacity, Image, TextInput, useColorScheme, StyleSheet, Animated, StatusBar
} from "react-native";
...
const styles = StyleSheet.create({
  ...
  dropdown: { borderWidth: 1, borderColor: GOLD_THEME.border, borderRadius: 10, paddingHorizontal: isSmallScreen ? 8 : 10, paddingVertical: isSmallScreen ? 6 : 8, backgroundColor: GOLD_THEME.white, minHeight: isSmallScreen ? 36 : 44, justifyContent: "center" },
