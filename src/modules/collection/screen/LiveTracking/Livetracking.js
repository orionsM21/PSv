  ...
  const metricCards = [
    {
      title: 'Online Users',
      value:
        countfilter?.onlineUser !== null && countfilter?.onlineUser !== undefined
    ...
    },
    {
      title: 'Offline Users',
      value:
        countfilter?.offlineUser !== null && countfilter?.offlineUser !== undefined
          ? countfilter.offlineUser
          : 0,
      onPress: () => navigation.navigate('OfflineUserList'),
    },
    {
      title: 'Scheduled Visits',
      value: countfilter?.scheduleVisit ?? 0,
    },
    {
      title: 'Completed',
      value: countfilter?.completedVisit ?? 0,
    },
    {
      title: 'Rescheduled',
      value: countfilter?.rescheduledVisit ?? 0,
    },
    {
      title: 'Cancelled',
      value: countfilter?.rejectedVisit ?? 0,
    },
    {
      title: 'Pending',
      value: countfilter?.pendingVisit ?? 0,
    },
  ];
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCopy}>
          <Text style={styles.headerEyebrow}>Collection Operations</Text>
      ...
      {messageVisible && (
        <View style={styles.refreshBanner}>
          <Text style={styles.refreshBannerText}>Tracking data refreshed</Text>
        </View>
      )}

      <View style={styles.toolbarCard}>
        <Text style={styles.toolbarTitle}>Tracking Window</Text>
        <Text style={styles.toolbarHint}>
          Choose the date and time range before searching movement and visit activity.
        </Text>
      ...
      <View style={styles.metricsWrap}>
        <View style={styles.metricsHeader}>
          <View>
            <Text style={styles.metricsTitle}>Tracking Summary</Text>
            <Text style={styles.metricsHint}>
              Tap online or offline counts to open the user lists.
            </Text>
          </View>
          ...
          <TouchableOpacity onPress={toggleFilters} style={styles.filterButton}>
            ...
            <Text style={styles.filterButtonText}>
              {filtersVisible ? 'Hide Filters' : `Filters${activeFilterCount ? ` (${activeFilterCount})` : ''}`}
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.metricsGrid}>
          {metricCards.map(card => {
            ...
            return (
              ...
              >
                <Text style={styles.metricTileTitle}>{card.title}</Text>
                <Text style={styles.metricTileValue}>{card.value}</Text>
              </CardComponent>
            );
          })}
        </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: moderateScale(18), fontWeight: '700', color: '#FFFFFF', marginTop: 2 },
  tabSection: {
    width: width * 0.3,
    height: height * 0.07,
    borderWidth: 1,
