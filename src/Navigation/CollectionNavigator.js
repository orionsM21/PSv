    ...
    <Stack.Navigator screenOptions={defaultStackScreenOptions}>
      ...
      {isLoggedIn && (
        <>
          ...
          <Stack.Screen
            name="ViewRequest"
            component={ViewReuest}
            options={{headerShown: true}}
          />
          <Stack.Screen
            name="ViewException"
            component={ViewException}
            options={{headerShown: true}}
          />
          <Stack.Screen
            name="PaymentDeposition"
            component={AddDeposition}
            options={{headerShown: true}}
          />
          <Stack.Screen
            name="DepositionHistory"
            component={DepositionHistory}
            options={{headerShown: true}}
          />
          <Stack.Screen
            name="FollowUpDueForToday"
            component={FollowUpDueForToday}
            options={{headerShown: true}}
          />
          ...
          <Stack.Screen
            name="OfflineUserList"
            component={OfflineUserList}
            options={{headerShown: true}}
          />
          <Stack.Screen
            name="OfflineSelectedUserdetailsMap"
            component={OfflineSelectedUserdetailsMap}
            options={{headerShown: true}}
          />
          <Stack.Screen
            name="OnlineSelectedUserdetailsMap"
            component={OnlineSelectedUserdetailsMap}
